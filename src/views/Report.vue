...
const filteredData = computed(() => {
  ...
  const userReportArray = Object.values(data.value);

  return lowerCaseQuery
    ? userReportArray.filter((UserReport) =>
      UserReport.fullname.toLowerCase().includes(lowerCaseQuery) ||
      UserReport.email.toLowerCase().includes(lowerCaseQuery)
    )
    : userReportArray;
});
        ...
        <tbody>
          <tr v-for="(item, index) in slicedData" :key="index">
            ...
            <td class=" py-5 text-sm bg-white border-b border-gray-200">
              <button class="px-6 py-3 mr-3 font-medium tracking-wide text-white btn-clr-primary rounded-md"
                  ...
                  <div v-for="dataID in dataByID" class="px-6 py-4 text-left modal-content">
                    ...
                    <div class="container mt-4">
                      <div class="proof d-flex">
                        <p>Proof image</p>
                        <img :src="dataID.proof_img_path" class="bg-gray-500 mt-3 justify-item-center" alt=""
