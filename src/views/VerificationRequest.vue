...
const fetchData = async () => {
  try {
    const response = await axios.get('/api/verification/all-list');
...
const getVerificationDetailsByID = async (id) => {
  try{
    const response = await axios.post('/api/verification/getVerificationListByID', {
      id: id,
    });
                  ...
                  <div
                    ...
                    <div v-for="dataID in dataByID" class="px-6 py-4 text-left modal-content">
                      ...
                      <div class="container flex">
                        <div class="verificationprofile flex-row">
                          <img class="bg-gray-500 mt-3" alt=""
                            style="height: 95px; width: 95px;">
                        </div>

                        <div class="profile-info flex-row ml-3" style="margin-top: 30px;">
                          <p class="mb-3">Legal Name: {{ dataID.legal_name }}</p>
                          <p>Date of Birth: {{ dataID.dob }}</p>
                        </div>
                      </div>
                          ...
                          <div class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                            <div class="flex items-center">
                              <div>
                                ...
                                <img :src="dataID.document_id" alt="">
                              </div>
                            </div>
                          </div>
                          <div class="px-5 py-5 text-sm bg-white border-b border-gray-200">
